...
insert into chi_tiet_hoa_don(MA_HD, MA_SP, SO_LUONG,DON_GIA, GIAM_GIA, LA_PHAN_TRAM) values
	(1,1,2,220000,10,true),
	(2,1,1,220000,0,false),
	(2,4,1,320000,0,false),
	(3,2,2,230000,10,true),
	(3,3,2,180000,10,true);
