          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                <%
                List<NhaCc> list =  new  NhaCcDAO().getAllNhaCc();
                	if (list != null) 
                	{
                		for (NhaCc nvx : list)
                		{
                ...
                %>
                <tr>
                    <td><a href="#" title="click vào để xem chi tiết"><%=nvx.getMaNcc() %></a></td>
                    <td><%=nvx.getTenNcc() %></td>
                    <td><%=nvx.getDiaChi() %></td>
                    <td><%=nvx.getSoDt() %></td>
                   
                    <td>
                      <button class="btn btn-link" data-toggle="modal" data-target="#modal-editemployee" onclick = "edit(<%=nvx.getMaNcc() %>,'<%=nvx.getTenNcc() %>','<%=nvx.getDiaChi() %>','<%=nvx.getSoDt() %>');"><span class="fa fa-edit">Sửa</span></button>
                      <span class="fa" style="margin: 0px 5px;"></span>
                      <a onclick="return confirmAction()" href="${pageContext.request.contextPath}/actionncc?MaNCC=<%=nvx.getMaNcc() %>"><span class="fa fa-remove">Xóa</span></a>
                    </td>
                  </tr>
                   <%
                		}
              ...
              <div class="modal-body">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="inputText11" placeholder="Tên nhà cung cấp" name="Tennv">
                  </div>
                </div>
